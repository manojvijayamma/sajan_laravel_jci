...

{
    ...
    private function _form($request,$id=0){  
        ...
        if($id>0){
            $this->data['content'] = Testimonial::find($id);            
        }  
        else{
            $this->data['content'] = new Testimonial();
        } 
    ...
    public function priority(Request $request){
        $input = $request->all();
        $menu = Testimonial::find($input['id']);        
