...
class CategoryController extends Controller
{
    ...
    { 
        ...
        $query = Category::with('childLevel1'); 
    ...
    private function _form($request,$id=0){  
        ...
        if($id>0){
            $this->data['content'] = Category::find($id);            
        }  
        else{
            $this->data['content'] = new Category();
        }        
        
        $this->data['mainCategory'] = Category::where('parent_id',0)->where('status',1)->get();
