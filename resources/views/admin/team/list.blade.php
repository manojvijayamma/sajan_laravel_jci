                                        ...
                                        @foreach ($content as $key => $row)
                                                                        ...
                                                                        <tr class="list-users">
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <a data-size="modal-lg" class="btn btn-primary btn-sm openPopup" href="javascript:void(0);" data-href="{{ url('admin/'.app('request')->input('controller').'/'.$row->id.'/edit?controller='.app('request')->input('controller').'&identifier='.app('request')->input('identifier')) }}" ><i class="fa fa-edit fa-fw"></i> Edit</a>
