                                ...
                                <div class="table-responsive gridPanel"  id="grid-table">
                                    <table class="table table-striped table-bordered table-hover" style="margin:0px;padding:0px">
                                        ...
                                        @foreach ($content as $key => $row)
                                                                        ...
                                                                        <tr class="list-users">
                                                                            <td>{{ ++$i }}</td>
                                                                            <td><div style="float:left;margin-top:5px;padding-left:5px;">{{ $row->title }}</div> </td>
                                                                           
                                                                            <td><img src="{{asset('uploads/challenge/'.$row->image)}}" style="height:30px;"></td>
