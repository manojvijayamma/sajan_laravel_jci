                ...
                <div class="section-title text-center mb-55">
                    ...
                    <?php if($listData){
                            foreach($listData as $val){
                                $dataFile=Download::where('parent_id',$val->id)->where('status','1')->get();
                                if(isset($dataFile) && count($dataFile)>0){?>
                        
                        <div class="row">

                                    <div class="col-sm-12">
                                                    <div class="down">
                                                            <h4><img src="{{asset('fe_theme/images/down.png')}}">&nbsp;&nbsp;<?php echo $val->title?></h4>
                                                    
                                                    </div>
                                                    <div class="row dwn">
                                                            
                                                            <?php foreach($dataFile as $valF){?>
                                                            <div class="col-sm-4">
                                                                <h5><a href="{{asset('uploads/download/'.$valF->image)}}" target="_blank"><img src="{{asset('fe_theme/images/dwn.png')}}"><?php echo $valF->title?></a></h5>
                                                            </div>
                                                            <?php } ?>        
